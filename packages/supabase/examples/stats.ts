...
bot
	...
	.command('start', (ctx) =>
		ctx.reply('Hi there! I will count the messages in this chat so you can get your /stats!')
	)

bot.on(':new_chat_members:me', (ctx) =>
	ctx.reply('Hi everyone! I will count the messages in this chat so you can get your /stats!')
)
